        ...
        <div className="home-container" style={{background: themeColor.bbg,transition: "1s"}}>
            <div className="content-container">
                ...
                <div className="btn-container">
                    <NavLink className='btn-link' style={{background: themeColor.hc,color: themeColor.hbg,transition: "1s"}}>Read More</NavLink>
                    <NavLink to='blogs' className='btn-link' style={{background: themeColor.hc,color: themeColor.hbg,transition: "1s"}}>Blogs</NavLink>
                </div>
            </div>
        </div>
     );
